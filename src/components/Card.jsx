...
const Card = ({ blog }) => {
    console.log(blog)
    const defaultImage = "https://www.shutterstock.com/image-vector/cute-cat-wear-dino-costume-600nw-2457633459.jpg"

    return (
        <>
            <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <img className="rounded-t-lg cursor-pointer" src={`http://localhost:3000/${blog.image}` || defaultImage} alt="useImage" />
                <div className="p-5">
                    <a href="#">
